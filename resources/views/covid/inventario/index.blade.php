      ...
      <div class="col-lg-12">
            <div class="card card-line-primary">
                <div class="card-header">
                  ...
                  <div class="card-body">
                    <button class="dt-button add-new btn btn-primary mb-md-0" tabindex="0" aria-controls="DataTables_Table_0" type="button" data-bs-toggle="modal" data-bs-target="#addPermissionModal"><span>Agregar Pruebas</span></button>
                        ...
                        <tbody>
                          @foreach ($inv as $row)
                              ...
                              <td>
                               <div class="btn-group">
                                  @can('Editar Permisos')
                                  <button type="button" class="btn btn-primary btn-sm " data-bs-toggle="modal" data-bs-target="#myModal{{ $row->id_inventario }}"><i class="mdi mdi-pencil mt-2 text-white" data-toggle="tooltip" data-placement="top"
                                title="Editar Permiso."></i></button>
                                 @endcan
                                @can('Eliminar Permisos')
                                  <form action="{{ route('permisos.destroy', $row->id_inventario) }}" method="POST"
            ...
            <div class="modal-body">
              ...
              {!! Form::open(['route' => ['permisos.store'],'method' => 'POST']) !!}
                <div class="col-12 mb-3">
                  ...
                  <input type="text" name="cantidad" id="modalPermissionName" name="modalPermissionName" class="form-control" placeholder="Intrese el nombre del permiso." autofocus required />
                </div>
